 ...
 * @test
 */
function make_command_with_attributes()
{
 ...
 * @test
 */
function make_command_without_attributes()
{
    $filepath = filepath('2015_10_21_072800_awesome_operation.php');
    File::delete($filepath);
 ...
 * @test
 */
function make_command_without_attributes_shortcut()
{
    $filepath = filepath('2015_10_21_072800_awesome_operation.php');
    File::delete($filepath);
...
test('the whole command process', function () {
    ...
    expect($operation->processed_at)->toEqual('2015-10-21 07:28:00');
    expect($operation->dispatched)->toEqual('async');
    ...
    expect($operation->name)->toEqual('2015_10_21_072800_awesome_operation');
    expect($operation->processed_at)->toEqual('2015-10-21 08:28:00');
    expect($operation->dispatched)->toEqual('async');
});
...
function sync_processing()
{
    ...
    expect($operation->dispatched)->toEqual('sync');
}

/**
 * @test
 */
function sync_processing_with_file_attribute()
{
    Queue::assertNothingPushed();
 ...
 * @test
 */
function processing_with_queue()
{
    Queue::assertNothingPushed();
 ...
 * @test
 */
function processing_with_test_flag()
{
 ...
 * @test
 */
function operations_show_command()
{
    // no files found
